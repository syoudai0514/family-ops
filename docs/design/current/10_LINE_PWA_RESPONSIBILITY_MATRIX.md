...
| M04 | Ask someone / request assignment change; light request uses `やる / 難しい / その他の返答`, assignment change uses `引き受ける / 難しい / 相談する`; checking, consultation, comment-softening, expiry, re-proposal, agreed-outside-app correction | **LINE MUST complete** | The request/assignment negotiation lifecycle must be operable in LINE, including stale/expired actions. Assignment-change acceptance uses one non-mutating final confirmation that exposes target/date/time/scope and material linked impact before mutation. Consultation stays in LINE. Work deadline and reply deadline remain distinct; acceptance converges onto linked ToDo execution truth. | Baseline §§7, 13.1, 14.2, 28.4; Q2, Q9, Q30, Q36, Q41-Q47, Q69, Q83-Q86; final UX §§7, 11; design 04 §§13-14, 26 |
...
| M10 | `誰でもOK` claim for execution and release when no longer taking it | **LINE MUST complete** | Daily execution cannot require PWA just to claim/release. LINE Today exposes the same-day `誰でもOK` entry contextually. Claim is not assignment rewrite and does not auto-expire; takeover first shows the CURRENT claimant before confirmation. | Baseline §6.5; Q107-Q109; final UX §9; design 04 §15 |

...
describe('anyone owner disclosure', () => {
  it('distinguishes unclaimed, self-claimed and family-claimed states', () => {
    ...
    expect(claimantDisclosure({ ...base, active_claimant_actor_ref_id: 'partner' }, 'me')).toBe('現在: 家族が対応中');
  });

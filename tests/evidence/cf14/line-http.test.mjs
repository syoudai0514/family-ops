...
test('Q27/Q70/Q71 LINE text evidence starts from a signed Messaging API HTTP envelope', async () => {
  const event = {
    type: 'message',
    mode: 'active',
...
test('Q27 LINE postback evidence starts from a signed Messaging API HTTP envelope', async () => {
  const event = {
    type: 'postback',
    mode: 'active',

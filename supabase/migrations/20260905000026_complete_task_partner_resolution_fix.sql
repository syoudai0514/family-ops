-- The compatibility complete-task RPC resolves "partner" from the household
-- membership table. household_members exposes joined_at, not created_at.
-- Keep the deterministic ordering without referencing a nonexistent column.

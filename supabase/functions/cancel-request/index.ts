...
// docs/design/v6/18_MUTATION_CONTRACT_MATRIX.md request section "cancel-request".
// Requester-only, pending-only — see the RPC migration's comment for why
// "pending-only" is doubly enforced (RPC check + DB CHECK constraint).

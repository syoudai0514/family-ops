...
// Requester cancellation uses the same observed RequestAttempt snapshot as all
// other request transitions. Never fetch a newer revision to make an old click
// succeed.

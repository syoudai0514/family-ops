...
const HTTP_STATUS_BY_CODE: Record<string, number> = {
  ...
  REQUEST_REPLY_DUE_IN_PAST: 409,
  REQUEST_ASSIGNMENT_REPROPOSAL_REQUIRED: 409,
  REQUEST_TERMS_REVISION_STALE: 409,
  ...
  ASSIGNMENT_AGREEMENT_REQUIRED: 409,
...
const KNOWN_CODES = new Set([
  ...
  "REQUEST_REPLY_DUE_IN_PAST",
  "REQUEST_ASSIGNMENT_REPROPOSAL_REQUIRED",
  "REQUEST_TERMS_REVISION_STALE",
...
export function describeCode(code: string): string {
  switch (code) {
    ...
    case "REQUEST_REPLY_DUE_IN_PAST":
    case "REQUEST_ASSIGNMENT_REPROPOSAL_REQUIRED":
    case "REQUEST_TERMS_REVISION_STALE":
    ...
    case "ASSIGNMENT_AGREEMENT_REQUIRED":
      return "担当を変える場合は、タスクの「担当を調整」から合意を確認してください";
